...
for i=2:size(M,1)
    ...
    whole_t = whole_t+traj(5,length(traj));
end 
t_vec= linspace(0,whole_t,length(whole_traj));
figure
plot(t_vec, whole_traj(1,:))
figure
plot(t_vec, whole_traj(3,:))
figure
plot(t_vec, whole_traj(4,:))
